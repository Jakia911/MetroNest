...
export default function PropertyListingSection() {
  ...
  // ---- FETCH PROPERTIES (same as before) ----
  useEffect(() => {
    ...
    <section className="w-full bg-[#f5f7fb] py-20">
      <div className="mx-auto max-w-[1600px] px-4 lg:px-0">
        ...
        <div className="flex gap-5 justify-center">
                  ...
                  <div className="space-y-2 text-xs">
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        className="h-3.5 w-3.5 rounded border-slate-300 text-black focus:ring-[#f05454]/30 text-black"
                      />
          ...
          {/* RIGHT: YOUR ORIGINAL PROPERTY CONTENT */}
          <div className="lg:w-[70%] w-full">
            {/* Loading state on the right side */}
            {loading && (
            ...
            {!loading && (
              <div
                className={
                  viewMode === "grid"
                    ? "grid grid-cols-1 gap-6 md:grid-cols-3 xl:grid-cols-3" // <-- same as your original
                    : "flex flex-col gap-6"
                }
              >
